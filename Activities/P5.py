...
List_= []
print ("Buenas tardes caballero, por favor introduzca 3 números para probar la funcion solicitada")
...
Number_2= int (input ("Tercer número por favor: \n"))
List_.insert(2, Number_2)
Higher_= Max_ (List_)
