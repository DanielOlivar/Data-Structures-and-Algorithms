def formaArreglo(tamano): #Crea arreglo del tamaÃ±o que se le indico en parentesis
...
def agregar(llave,valor,map,tamano): 
    ...
    if map[llave_hash] is None: #Si esta vacio aqui agregará algun elemento
        map[llave_hash]=list([ParllaveValor])
        return True
    else: #Entra en acción cuando hay una colision
